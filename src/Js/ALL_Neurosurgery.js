...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/neurosurgery', true);
...
export default class ALL_Neurosurgery extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/neurosurgery')
      .then(response => {
