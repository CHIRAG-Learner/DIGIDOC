...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/cardiology', true);
...
export default class ALL_Cardiology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/cardiology')
      .then(response => {
