...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/orthopaedics', true);
...
export default class AUR_Orthopaedics extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/orthopaedics')
      .then(response => {
