...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/neurosurgery', true);
...
export default class AUR_Neurosurgery extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/neurosurgery')
      .then(response => {
