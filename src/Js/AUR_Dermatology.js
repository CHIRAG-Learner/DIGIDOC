...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/dermatology', true);
...
export default class AUR_Dermatology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/dermatology')
      .then(response => {
