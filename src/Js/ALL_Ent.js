...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/ent', true);
...
export default class ALL_Ent extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/ent')
      .then(response => {
