...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/anaesthesia', true);
...
export default class AUR_Anaesthesia extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/anaesthesia')
      .then(response => {
