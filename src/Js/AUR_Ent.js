...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/ent', true);
...
export default class AUR_Ent extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/ent')
      .then(response => {
