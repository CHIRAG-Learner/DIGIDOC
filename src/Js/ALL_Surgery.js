...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/surgery', true);
...
export default class ALL_Surgery extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/surgery')
      .then(response => {
