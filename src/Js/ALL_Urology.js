...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/urology', true);
...
export default class ALL_Urology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/urology')
      .then(response => {
