...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/obst', true);
...
export default class ALL_Obst extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/obst')
      .then(response => {
