...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/cardiology', true);
...
export default class AUR_Cardiology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/cardiology')
      .then(response => {
