...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/ophthalmology', true);
...
export default class ALL_Ophthalmology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/ophthalmology')
      .then(response => {
