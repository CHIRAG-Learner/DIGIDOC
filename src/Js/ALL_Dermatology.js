...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/dermatology', true);
...
export default class ALL_Dermatology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/dermatology')
      .then(response => {
