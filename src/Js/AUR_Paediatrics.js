...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/paediatrics', true);
...
export default class AUR_Paediatrics extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/paediatrics')
      .then(response => {
