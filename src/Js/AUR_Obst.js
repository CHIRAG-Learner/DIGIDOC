...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/obst', true);
...
export default class AUR_Obst extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/obst')
      .then(response => {
