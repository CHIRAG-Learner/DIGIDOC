...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/surgery', true);
...
export default class AUR_Surgery extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/surgery')
      .then(response => {
