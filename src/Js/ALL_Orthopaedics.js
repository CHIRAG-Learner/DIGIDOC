...
var images = require.context('../Backened/ADMIN_WALLET/allopathic/orthopaedics', true);
...
export default class ALL_Orthopaedics extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/allopathic/orthopaedics')
      .then(response => {
