...
var images = require.context('../Backened/ADMIN_WALLET/ayurvedic/ophthalmology', true);
...
export default class AUR_Ophthalmology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/ayurvedic/ophthalmology')
      .then(response => {
