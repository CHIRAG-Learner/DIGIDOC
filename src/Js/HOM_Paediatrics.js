...
var images = require.context('../Backened/ADMIN_WALLET/homeopathic/paediatrics', true);
...
export default class HOM_Paediatrics extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/homeopathic/paediatrics')
      .then(response => {
  ...
  return (
     <div >  
       ...
       <br/>
       <br/>
       <h1 className="kok">Paediatrics<span align="right"><button onClick={this.onSub}>BACK</button></span></h1>
    <br/>
    <br/>
