...
var images = require.context('../Backened/ADMIN_WALLET/homeopathic/cardiology', true);
...
export default class HOM_Cardiology extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/homeopathic/cardiology')
      .then(response => {
  ...
  return (
     <div >  
       ...
       <br/>
       <br/>
       <h1 className="kok">Cardiology<span align="right"><button onClick={this.onSub}>BACK</button></span></h1>
    <br/>
    <br/>
