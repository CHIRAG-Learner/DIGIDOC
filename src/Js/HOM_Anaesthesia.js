...
var images = require.context('../Backened/ADMIN_WALLET/homeopathic/anaesthesia', true);
...
export default class HOM_Anaesthesia extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/homeopathic/anaesthesia')
      .then(response => {
  ...
  return (
     <div >  
       ...
       <br/>
       <br/>
       <h1 className="kok">Anaesthesia<span align="right"><button onClick={this.onSub}>BACK</button></span></h1>
    <br/>
    <br/>
