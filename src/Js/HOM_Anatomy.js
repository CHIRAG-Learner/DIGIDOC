...
var images = require.context('../Backened/ADMIN_WALLET/homeopathic/anatomy', true);
...
export default class HOM_Anatomy extends Component 
{
  constructor(props) {
    super(props);
    this.state = {exercises: []};
                ...
                componentDidMount() 
  {
    axios.get('http://localhost:5000/get/homeopathic/anatomy')
      .then(response => {
